...
public class Card {
     ...
     * int cardId=resultSet.getInt(1);
					...
					cards.add(new Card(saleTitle,cardId, monthFee, oprator, roughImageAddress, price,cardName,voiceTraiff,smsAmmsTraiff,flowTraiff));
     */
    public Card(int cardId,String monthFee,String oprator,String roughImageAddress,int price,String saleTitle,String cardName,String voiceTraiff,String smsAmmsTraiff,String flowTraiff) {
    	...
    	this.saleTitle=saleTitle;
    	this.cardName=cardName;
    	this.voiceTariff=voiceTraiff;
    	this.smsAmmsTariff=smsAmmsTraiff;
    	this.flowTariff=flowTraiff;
    }
    ...
    public Card(String saleTitle,int cardId, String monthFee, String oprator, String roughImageAddress, int price,String cardName){
    	this.cardId=cardId;
    	this.monthFee=monthFee;
    	this.oprator=oprator;
    	this.roughImageAddress=roughImageAddress;
    ...
    public Card(int cardId, int price, String oprator, String cardName,String roughImageAddress) {
		this.cardId=cardId;
		this.price=price;
		this.oprator=oprator;
		this.cardName=cardName;
